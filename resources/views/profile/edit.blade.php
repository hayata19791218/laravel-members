            ...
            <div class="card-body">
                ...
                <form method="post" action="{{route('profile.update', $user)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <img src="{{asset('storage/avatar/'.($user->avatar??'user_default.jpg'))}}" class="d-block rounded-circle mb-3" style="height:100px;width:auto;">
                        <div>
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input id="password" type="password" class="form-control" name="password" placeholder="パスワードを入力してください" required autocomplete="new-password">
                    </div>
